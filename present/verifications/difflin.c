/*
Evaluate the correlation of a linear 
approximation for reduced-round PRESENT

Original author: Thomas Siebert (thomas.siebert@rub.de)
Modifed by:  (hsn.hadipour@gmail.com)
Date: July 8, 2022
*/
